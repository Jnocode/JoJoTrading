...
if exist "pages\enhanced\00_User_Center.py" (
    ...
    streamlit run "pages\enhanced\00_👤_User_Center.py"
)
pause
goto MENU
...
if exist "pages\enhanced\00_Navigation.py" (
    ...
    streamlit run "pages\enhanced\00_🎯_Navigation.py"
)
pause
goto MENU
...
if exist "pages\enhanced\advanced\08_AI_Stock_Predictor.py" (
    ...
    streamlit run "pages\enhanced\advanced\08_🤖_AI_Stock_Predictor.py"
)
pause
goto MENU
...
if exist "pages\enhanced\02_DCF_Calculator.py" (
    ...
    streamlit run "pages\enhanced\02_📊_DCF_Calculator.py"
)
pause
goto MENU
...
echo.
echo [檔案結構檢查]
if exist "pages\enhanced\00_User_Center.py" (echo [成功] 用戶中心 (無emoji版)) else if exist "pages\enhanced\00_👤_User_Center.py" (echo [成功] 用戶中心 (emoji版)) else (echo [錯誤] 用戶中心)
if exist "pages\enhanced\advanced\08_AI_Stock_Predictor.py" (echo [成功] AI預測 (無emoji版)) else if exist "pages\enhanced\advanced\08_🤖_AI_Stock_Predictor.py" (echo [成功] AI預測 (emoji版)) else (echo [錯誤] AI預測)
