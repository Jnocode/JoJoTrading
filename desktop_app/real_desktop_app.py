...
# 添加專案 src 目錄到 path (Critical fix for imports)
current_dir = os.path.dirname(os.path.abspath(__file__))
# current_dir is .../trading/jojo_trading/desktop_app
# parent is .../trading/jojo_trading
root_dir = os.path.dirname(current_dir)
# src is .../trading/jojo_trading/src
