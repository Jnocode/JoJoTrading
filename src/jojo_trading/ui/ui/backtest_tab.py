...
class BacktestTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.input_capital.setMinimumWidth(100)
        self.input_capital.setMaximumWidth(150)
        ...
        self.input_start.setMinimumWidth(100)
        self.input_start.setMaximumWidth(150)
        ...
        self.input_end.setMinimumWidth(100)
        self.input_end.setMaximumWidth(150)
        ...
        self.combo_interval.setMinimumWidth(110)
        self.combo_interval.setMaximumWidth(150)
