...
class SentimentRatioBar(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Base background (Neutral / Dark Gray)
...
class NewsItemWidget(QFrame):
    ...
    def _apply_analysis(self, analysis):
        ...
        if sentiment == 'Bullish': 
            ...
            sent_bg = "#388E3C"
            display_sent = "📉 " + sentiment
        elif sentiment == 'RateLimit': 
            sent_bg = "#F57F17"
            display_sent = "⚠️ AI LIMIT"
        else:
            display_sent = "➖ " + sentiment
...
class NewsTab(QWidget):
    ...
    def setup_ui(self):
        ...
        lbl_bear_legend.setStyleSheet("color: #388E3C; font-size: 10px;")
        lbl_bull_legend = QLabel("看多 ▶")
        lbl_bull_legend.setStyleSheet("color: #D32F2F; font-size: 10px;")
